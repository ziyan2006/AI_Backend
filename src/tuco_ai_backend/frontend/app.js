...
const LEVEL_DATA = {
  ...
  150: { level_id: 150, title: "非门熔炉", short_goal: "【实战关卡】击退敌机巡逻编队，熟练发射激光炮。", input_names: "手动发射 A", output_names: "主炮 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] },
  ...
  250: { level_id: 250, title: "加法器航道", short_goal: "【实战关卡】高速俯冲编队冲击护罩，依靠强化火力穿过航道。", input_names: "能量火炮 A", output_names: "护罩主炮 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] },
  ...
  350: { level_id: 350, title: "与门堡垒", short_goal: "【实战关卡】清理敌机编队，打开古文明堡垒通道。", input_names: "双发光束 A", output_names: "堡垒通道 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] },
  ...
  450: { level_id: 450, title: "奇偶回路", short_goal: "【实战关卡】依靠贯星能量炮穿过敌方阵列。", input_names: "贯星主炮 A", output_names: "回路输出 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] },
  ...
  550: { level_id: 550, title: "异或反应堆", short_goal: "【实战关卡】击破守卫和反应堆首领，恢复能量稳定。", input_names: "全加主炮 A", output_names: "反应堆核心 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] },
  ...
  650: { level_id: 650, title: "与门要塞", short_goal: "【终极关卡】驾驶完全强化的图灵号攻克最终要塞！", input_names: "终极火炮 A", output_names: "要塞核心 Y", input_count: 1, output_count: 1, truth_table: [{ in: [1], out: [1] }] }
};
